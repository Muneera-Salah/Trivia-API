...
def create_app(test_config=None):
  ...
  def questions():
    ...
    if len(current_questions) == 0:
      ...
      categories = {}  
      query_result2 = Category.query.all()
      for category in query_result2:
        categories[category.id] = category.type
  ...
  def search_questions():
    ...
    selection_questions = Question.query.filter(Question.question.ilike('%' + searchTerm +'%')).all()
  ...
  def get_questions_quiz():
    ...
    try:
      if quiz_category['id'] == 0 :
        ...
        selection_questions = Question.query.filter(Question.category == quiz_category['id']).all()
        formatted_questions = [question.format() for question in selection_questions]
